# Generated by Django 4.2.2 on 2023-08-27 18:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dose1_status', models.CharField(blank=True, choices=[('Pending', 'Pending'), ('Given', 'Given'), ('Missed', 'Missed')], default='Pending', max_length=15, null=True)),
                ('dose2_status', models.CharField(blank=True, choices=[('Pending', 'Pending'), ('Given', 'Given'), ('Missed', 'Missed')], default='Pending', max_length=15, null=True)),
                ('dose3_status', models.CharField(blank=True, choices=[('Pending', 'Pending'), ('Given', 'Given'), ('Missed', 'Missed')], default='Pending', max_length=15, null=True)),
                ('dose4_status', models.CharField(blank=True, choices=[('Pending', 'Pending'), ('Given', 'Given'), ('Missed', 'Missed')], default='Pending', max_length=15, null=True)),
