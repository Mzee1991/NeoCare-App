# Generated by Django 4.2.2 on 2023-08-23 05:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('treatment_status', models.CharField(choices=[('Pending', 'Pending'), ('Given', 'Given'), ('Missed', 'Missed')], max_length=15)),
                ...
                ('dispenser', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='prescriptions_dispensed', to=settings.AUTH_USER_MODEL)),
