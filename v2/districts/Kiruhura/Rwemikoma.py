...
def populate_database():
    ...
    # Create Subcounty - Rwemikoma
    subcounty, _ = Subcounty.objects.get_or_create(county_municipality=county_municipality, name='Rwemikoma')

    # Create Parishes and Villages for each parish

    parishes_and_villages = [
        ('Rwemikoma', ['Bisya', 'Rwemikoma', 'Kariba i', 'Kariba ii', 'Ryentanga', 'Mukuru']),
        ('Migina', ['Akafene', 'Kabaure', 'Kikoni central', 'Kikoni i', 'Kikoni ii', 'Katongore i', 'Katongore ii', 'Kashambya', 'Kyembogo', 'Kagando', 'Migina']),
        ('Kijuma', ['Bukumbagare', 'Kijuma', 'Kigarama', 'Katengyeto', 'Nyamirima', 'Kaikoti', 'Kyenturegye', 'Mugore']),
        ('Bugarihe', ['Bugaruhe i', 'Bugaruhe ii', 'Rwekishwaga', 'Muko', 'Rukinga', 'Rwakakungu']),
    ]
