...
def populate_database():
    ...
    # Create Subcounty - Kikatsi
    subcounty, _ = Subcounty.objects.get_or_create(county_municipality=county_municipality, name='Kikatsi')

    # Create Parishes and Villages for each parish

    parishes_and_villages = [
        ('Keikoti', ['Kigabagaba', 'Ekiyonza', 'Rwebitete', 'Kaikoti central', 'Kanyanya k.', 'Karaza', 'Rukaya']),
        ('Kayonza', ['Ekimomo', 'Kayonza', 'Karuroko', 'Rugaaga']),
        ('Kanyanya', ['Bitahatsi', 'Bubaare', 'Ifura', 'Ekihama', 'Kanyanya a', 'Kanyanya b', 'Rwenkombero', 'Rweshande', 'Rushenyi']),
        ('Embare', ['Akati', 'Akabaare', 'Bunonko', 'Kikatsi', 'Byembogo', 'Kyeibuza', 'Ruhengyere', 'Ngira']),
    ]
