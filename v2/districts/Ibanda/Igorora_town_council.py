...
def populate_database():
    ...
    # Create Subcounty - Igorora town council
    subcounty, _ = Subcounty.objects.get_or_create(county_municipality=county_municipality, name='Igorora town council')

    # Create Parishes and Villages

    parishes_and_villages = [
        ('Igorora ward', ['Igorora', 'Kigando i', 'Kigando ii', 'Kigando iii', 'Embaho', 'Kanyeganyegye', 'Kyarukumba ii', 'Ngango i', 'Ngango ii', 'Ngango iii', 'Ntungamo i', 'Ntungamo ii']),
    ]
