...
def populate_database():
    ...
    # Create Subcounty - Nyabuhikye
    subcounty, _ = Subcounty.objects.get_or_create(county_municipality=county_municipality, name='Nyabuhikye')

    # Create Parishes and Villages

    parishes_and_villages = [
        ('Bwahwa', ['Kiziira', 'Kasese', 'Kyentaama', 'Nyakatete', 'Rugoba', 'Rujumbura', 'Nkombe']),
    ]
