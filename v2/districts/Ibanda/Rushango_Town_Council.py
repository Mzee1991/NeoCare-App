...
def populate_database():
    ...
    # Create Subcounty - Rushango town council
    subcounty, _ = Subcounty.objects.get_or_create(county_municipality=county_municipality, name='Rushango town council')

    # Create Parishes and Villages

    parishes_and_villages = [
        ('Tabyama ward', ['Itabyama b', 'Itabyama c', 'Rwemirama', 'Ryabiju a', 'Mugyengyezi i']),
        ('Rushango ward', ['Katikamwe a', 'Karambi a', 'Karambi b', 'Rushango a', 'Rushango b']),
    ]
